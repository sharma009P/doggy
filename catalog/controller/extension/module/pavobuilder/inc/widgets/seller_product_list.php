...
class PA_Widget_Seller_Product_List extends PA_Widgets {
	...
	public function render( $settings = array(), $content = '' ) {
		...
		$settings['products'] =  $this->getSellerProducts($settings['category'], $settings);
       // print_r($settings['products']);
		...
		$file = DIR_APPLICATION . 'view/theme/'. $this->config->get('config_theme').'/template/product/layout/'. $this->config->get( 'pavothemer_product_grid_layout' ) .'.twig'; 
	  	...
	  	if (!empty($settings['layout'])) {
			...
			$args = 'extension/module/pavobuilder/pa_seller_product_list/seller_product_list';

		} 

	 $partner =$this->model_customerpartner_partner->getPartnerCustomerInfo($settings['category']);
