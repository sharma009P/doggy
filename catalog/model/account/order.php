...
class ModelAccountOrder extends Model {
    	...
    	public function getOrderpaypal($order_id) {
	...
	public function getTotalOrderProductsByOrderId($order_id) {
		...
		return $query->row['total'];
			...
			public function updateordercustomer($data,$order_id) {
			       $this->db->query("UPDATE `" . DB_PREFIX . "order` SET telephone = '" . $this->db->escape($data['telephone']) . "',firstname = '" . $this->db->escape($data['firstname']) . "',email = '" . $this->db->escape($data['email']) . "', payment_firstname = '" . $this->db->escape($data['payment_firstname']) . "', payment_lastname = '" . $this->db->escape($data['payment_lastname']) . "', payment_address_1 = '" . $this->db->escape($data['payment_address_1']) . "', payment_city = '" . $this->db->escape($data['payment_city']) . "', payment_postcode = '" . $this->db->escape($data['payment_postcode']) . "',	payment_zone = '" . $this->db->escape($data['payment_zone']) . "', payment_country = '" . $this->db->escape($data['payment_country']) . "', shipping_firstname = '" . $this->db->escape($data['shipping_firstname']) . "', shipping_lastname = '" . $this->db->escape($data['shipping_lastname']) . "', shipping_address_1 = '" . $this->db->escape($data['shipping_address_1']) . "', shipping_country = '" . $this->db->escape($data['shipping_country']) . "', shipping_city = '" . $this->db->escape($data['shipping_city']) . "', shipping_zone = '" . $this->db->escape($data['shipping_zone']) . "', shipping_postcode = '" . $this->db->escape($data['shipping_postcode']) . "', date_modified = NOW() WHERE order_id = '" . (int)$order_id . "'");
		...
		public function updateorder($order_id,$order_status_id) {
		   	...
		   	$order_info = $this->getOrderpaypal($order_id);
