...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_shipping_text'])) {
			$data['config_shipping_text'] = $this->request->post['config_shipping_text'];
		} else {
			$data['config_shipping_text'] = $this->config->get('config_shipping_text');
		}
