		...
		this.isValidEmailAddress = function (emailAddress) {
 		...
 		this.submit = function ( _form ) { 
 			...
 			$( _form ).on('submit', function() {
				...
				form.find('.valid').html("<div class=\"error alert alert-danger\">"+_this.msg+"<button type=\"button\" class=\"close\" data-dismiss=\"alert\">×</button></div></div>");
				form.find('.inputNew').focus();
				return false;
			}
			...
			$.ajax({
				...
				success: function(json)
				{
					$(".success_inline, .warning_inline, .error").remove();
					if (json['error']) {
						form.find('.valid').html("<div class=\"warning_inline alert alert-danger\">"+json['error']+"<button type=\"button\" class=\"close\" data-dismiss=\"alert\">×</button></div>");
					}
					if (json['success']) {
						form.find('.valid').html("<div class=\"success_inline alert alert-success\">"+json['success']+"<button type=\"button\" class=\"close\" data-dismiss=\"alert\">×</button></div>");
					}
				}
			});
			return false;
